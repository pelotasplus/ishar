...
**98 assets, 2,370,078 bytes decoded, 62.0% of those bytes named.**
...
| [`message.io`](#messageio) | 8,712 | text | 54% | **use directly** — strings (10) |
| [`messaged.io`](#messagedio) | 8,600 | text | 55% | **use directly** — strings (10) |
| [`messagee.io`](#messageeio) | 8,416 | text | 45% | **use directly** — strings (10) |
| [`messagei.io`](#messageiio) | 8,600 | text | 55% | **use directly** — strings (10) |
...
| [`textin.io`](#textinio) | 11,896 | text | 67% | **use directly** — strings (10) |
| [`textind.io`](#textindio) | 11,568 | text | 66% | **use directly** — strings (10) |
| [`textine.io`](#textineio) | 11,480 | text | 63% | **use directly** — strings (10) |
| [`textini.io`](#textiniio) | 11,472 | text | 66% | **use directly** — strings (10) |
...
| 4,703..5,077 | 374 | UNEXPLAINED |
| 5,077..5,197 | 120 | 4 `1e 04` records, a list: 'SAUVEGARDER LA PARTIE EN COURS'..'EXIT' (3.22b) |
| 5,197..5,584 | 387 | UNEXPLAINED |
| 5,584..6,600 | 1,016 | 41 `1e 04` records, a list: 'TABLETTE RUNIQUE'..'OS DE DRAGON' (3.22b) |
...
| 7,439..7,686 | 247 | 14 NUL-terminated strings (+118 b between) (10) |
| 7,686..7,772 | 86 | UNEXPLAINED |
| 7,772..8,550 | 778 | 33 `1e 04` records, a list: 'GUERISON 1'..'EQUIPE INVISIBLE 5' (3.22b) |
| 8,550..8,712 | 162 | UNEXPLAINED |

**53.9% named.** **use directly** — strings (10)
...
| 4,686..5,060 | 374 | UNEXPLAINED |
| 5,060..5,129 | 69 | 4 `1e 04` records, a list: 'SPIEL SICHERN'..'EXIT' (3.22b) |
| 5,129..5,516 | 387 | UNEXPLAINED |
| 5,516..6,510 | 994 | 41 `1e 04` records, a list: 'RUNEN TAFEL'..'DRACHENKNOCHEN' (3.22b) |
| 6,510..6,638 | 128 | UNEXPLAINED |
| 6,638..7,157 | 519 | 13 NUL-terminated strings (+185 b between) (10) |
| 7,157..7,212 | 55 | UNEXPLAINED |
| 7,212..7,285 | 73 | 5 `1e 04` records, a list: 'MENSCHLICH'..'EIDECHSE' (3.22b) |
| 7,285..7,336 | 51 | UNEXPLAINED |
| 7,336..7,629 | 293 | 17 `1e 04` records, a list: 'PALADIN'..'OKKULTER M$NCH' (3.22b) |
| 7,629..7,714 | 85 | UNEXPLAINED |
| 7,714..8,441 | 727 | 33 `1e 04` records, a list: 'HEILUNG 1'..'UNSICHTBARES TEAM 5' (3.22b) |
| 8,441..8,600 | 159 | UNEXPLAINED |

**55.0% named.** **use directly** — strings (10)
...
| 866..2,767 | 1,901 | 50 NUL-terminated strings (+1,070 b between) (10) |
| 2,767..2,791 | 24 | UNEXPLAINED |
| 2,791..2,890 | 99 | 3 `1e 04` records, a list: "THAT DOESN'T WORK WITH ME!"..'WARM TEAR, FELLOW SUFFERERS!' (3.22b) |
| 2,890..2,898 | 8 | UNEXPLAINED |
| 2,898..4,254 | 1,356 | 32 NUL-terminated strings (+296 b between) (10) |
| 4,254..4,362 | 108 | UNEXPLAINED |
| 4,362..4,604 | 242 | 6 NUL-terminated strings (+52 b between) (10) |
| 4,604..4,978 | 374 | UNEXPLAINED |
| 4,978..5,010 | 32 | **@4978** - the main menu: 4 entries -- SAVE CURRENT GAME, LOAD PREVIOUS SAVED GAME, PLAY A NEW GAME, EXIT (FINDINGS 6.16) (7) |
| 5,010..5,039 | 29 | UNEXPLAINED |
| 5,039..5,055 | 16 | 1 NUL-terminated strings (10) |
| 5,055..5,456 | 401 | UNEXPLAINED |
| 5,456..5,488 | 32 | **@5456** - **the item list**: 41 records of `1e 04 <NAME> 00`, index 0..40 -- RUNE TABLET..DRAGON BONE, with the weapon and armour bonus in the name (FINDINGS 6.16) (7) |
| 5,488..5,500 | 12 | UNEXPLAINED |
| 5,500..6,391 | 891 | 36 NUL-terminated strings (+357 b between) (10) |
| 6,391..6,519 | 128 | UNEXPLAINED |
| 6,519..6,592 | 73 | 2 NUL-terminated strings (+8 b between) (10) |
| 6,592..6,598 | 6 | UNEXPLAINED |
| 6,598..6,630 | 32 | **@6598** - the incantation list: 6 records, WORD : EFFECT -- CLOPATOS..KRAKOS (FINDINGS 6.16) (7) |
| 6,630..6,635 | 5 | UNEXPLAINED |
| 6,635..6,659 | 24 | 1 NUL-terminated strings (10) |
| 6,659..6,671 | 12 | UNEXPLAINED |
| 6,671..6,787 | 116 | 4 `1e 04` records, a list: 'WORGAZ : APNEA'..'KRAKOS : BRAIN WASH' (3.22b) |
| 6,787..6,799 | 12 | UNEXPLAINED |
| 6,799..6,994 | 195 | 4 NUL-terminated strings (+115 b between) (10) |
...
| 7,166..7,198 | 32 | **@7166** - **the class list**: 17 records of `1e 04 <NAME> 00`, index 0..16 -- PALADIN..OCCULT MONK; THIEF is 4 (FINDINGS 6.15) (7) |
| 7,198..7,200 | 2 | UNEXPLAINED |
| 7,200..7,435 | 235 | 12 NUL-terminated strings (+128 b between) (10) |
| 7,435..7,520 | 85 | UNEXPLAINED |
| 7,520..7,552 | 32 | **@7520** - **the spell list**: 33 records of `1e 04 <NAME> 00`, index 0..32 -- HEALING 1..INVISIBLE TEAM 5, level in the name (FINDINGS 6.16) (7) |
| 7,552..7,560 | 8 | UNEXPLAINED |
| 7,560..8,257 | 697 | 31 NUL-terminated strings (+270 b between) (10) |
| 8,257..8,416 | 159 | UNEXPLAINED |

**44.7% named.** **use directly** — strings (10)
...
| 4,641..5,015 | 374 | UNEXPLAINED |
| 5,015..5,104 | 89 | 4 `1e 04` records, a list: 'REGISTRARE IL GIOCO'..'EXIT' (3.22b) |
| 5,104..5,492 | 388 | UNEXPLAINED |
| 5,492..6,515 | 1,023 | 41 `1e 04` records, a list: 'TAVOLA RUNICA'..'OSSO DI DRAGO' (3.22b) |
| 6,515..6,643 | 128 | UNEXPLAINED |
| 6,643..7,148 | 505 | 13 NUL-terminated strings (+185 b between) (10) |
| 7,148..7,202 | 54 | UNEXPLAINED |
| 7,202..7,252 | 50 | 4 `1e 04` records, a list: 'UMANO'..'ORCO' (3.22b) |
| 7,252..7,304 | 52 | UNEXPLAINED |
| 7,304..7,574 | 270 | 17 `1e 04` records, a list: 'PALADINO'..'MONACO' (3.22b) |
| 7,574..7,660 | 86 | UNEXPLAINED |
| 7,660..8,434 | 774 | 33 `1e 04` records, a list: 'GUARIGIONE 1'..'SQUADRA INVISIBILE 5' (3.22b) |
| 8,434..8,600 | 166 | UNEXPLAINED |

**55.1% named.** **use directly** — strings (10)
...
| 7,125..7,644 | 519 | UNEXPLAINED |
| 7,644..7,700 | 56 | 4 `1e 04` records, a list: 'ECOUTER'..'ENROLER' (3.22b) |
| 7,700..7,786 | 86 | UNEXPLAINED |
| 7,786..9,343 | 1,557 | 30 NUL-terminated strings (+560 b between) (10) |
| 9,343..9,654 | 311 | UNEXPLAINED |
| 9,654..10,559 | 905 | 33 `1e 04` records, a list: 'ARMURE DE CUIR (+2)'..'OS DE DRAGON' (3.22b) |
| 10,559..10,804 | 245 | UNEXPLAINED |
| 10,804..11,751 | 947 | 35 `1e 04` records, a list: 'GUERISON 1'..'EQUIPE INVISIBLE 5' (3.22b) |
| 11,751..11,896 | 145 | UNEXPLAINED |

**67.3% named.** **use directly** — strings (10)
...
| 7,010..7,528 | 518 | UNEXPLAINED |
| 7,528..7,581 | 53 | 4 `1e 04` records, a list: 'ZUH$REN'..'NEUER' (3.22b) |
| 7,581..7,667 | 86 | UNEXPLAINED |
| 7,667..9,105 | 1,438 | 30 NUL-terminated strings (+565 b between) (10) |
| 9,105..9,416 | 311 | UNEXPLAINED |
| 9,416..10,298 | 882 | 33 `1e 04` records, a list: 'LEDERR#STUNG (+2)'..'DRACHENKNOCHEN' (3.22b) |
| 10,298..10,542 | 244 | UNEXPLAINED |
| 10,542..11,423 | 881 | 35 `1e 04` records, a list: 'HEILUNG 1'..'UNSICHTBARES TEAM 5' (3.22b) |
| 11,423..11,568 | 145 | UNEXPLAINED |

**66.4% named.** **use directly** — strings (10)
...
| 6,995..7,514 | 519 | UNEXPLAINED |
| 7,514..7,546 | 32 | **@7514** - 4 of the ACTION verbs: LISTEN, EAT, SLEEP, RECRUIT (FINDINGS 6.16) (7) |
| 7,546..7,557 | 11 | UNEXPLAINED |
| 7,557..9,065 | 1,508 | 31 NUL-terminated strings (+646 b between) (10) |
| 9,065..9,376 | 311 | UNEXPLAINED |
| 9,376..9,408 | 32 | **@9376** - a second equipment list, 33 entries -- different count from messagee.io's 41, not reconciled (FINDINGS 6.16) (7) |
| 9,408..9,410 | 2 | UNEXPLAINED |
| 9,410..10,219 | 809 | 29 NUL-terminated strings (+387 b between) (10) |
| 10,219..10,464 | 245 | UNEXPLAINED |
| 10,464..11,342 | 878 | 35 `1e 04` records, a list: 'HEALING 1'..'INVISIBLE TEAM 5' (3.22b) |
| 11,342..11,480 | 138 | UNEXPLAINED |

**62.7% named.** **use directly** — strings (10)
...
| 6,884..7,402 | 518 | UNEXPLAINED |
| 7,402..7,457 | 55 | 4 `1e 04` records, a list: 'ASCOLTA'..'RECLUTA' (3.22b) |
| 7,457..7,543 | 86 | UNEXPLAINED |
| 7,543..8,994 | 1,451 | 30 NUL-terminated strings (+560 b between) (10) |
| 8,994..9,306 | 312 | UNEXPLAINED |
| 9,306..10,215 | 909 | 33 `1e 04` records, a list: 'ARMATURA DI CUOIO (+2)'..'OSSO DI DRAGO' (3.22b) |
| 10,215..10,460 | 245 | UNEXPLAINED |
| 10,460..11,330 | 870 | 33 `1e 04` records, a list: 'GUARIGIONE 1'..'SQUADRA INVISIBILE 5' (3.22b) |
| 11,330..11,472 | 142 | UNEXPLAINED |

**66.1% named.** **use directly** — strings (10)
